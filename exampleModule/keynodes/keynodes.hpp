...
public:
  ...
  SC_PROPERTY(Keynode("question_find_headman"), ForceCreate)
  static ScAddr question_find_headman;

  SC_PROPERTY(Keynode("nrel_headman"), ForceCreate)
  static ScAddr nrel_headman;
};
