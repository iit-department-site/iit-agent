...
#include <iostream>
#include "HeadmanSearchAgent.hpp"
...
SC_AGENT_IMPLEMENTATION(HeadmanSearchAgent)
{
	SC_LOG_ERROR("HeadmanSearchAgent started")
  ...
  ScAddr answer = getHeadmanNode(logger,ms_context,node);
